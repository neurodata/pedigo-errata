...
[![Jupyter Book Badge](https://jupyterbook.org/badge.svg)](http://docs.neurodata.io/pedigo-errata/)
...
- Navigate to a directory where you want to store the project, and clone this repo: 
   ```
   git clone https://github.com/neurodata/pedigo-errata
   ```
...
- Create a Poetry environment:
  ...
  - For me, the output looks like
     ```
    Creating virtualenv pedigo-errata in /Users/bpedigo/bilateral-test/pedigo-errata/.venv
    Using virtualenv: /Users/bpedigo/bilateral-test/pedigo-errata/.venv
    ```
...
- Now you should be able to run any individual python files like normal, for example: 
  ```
  python ./pedigo-errata/scripts/er_unmatched_test.py
  ```
- Instead of running as a Python file, you can also easily convert a Python file to a
  ...
  ```
  sh ./pedigo-errata/shell/make_notebook er_unmatched_test
  ```
...
- To build the documentation, do:
  ```
  jb build ./pedigo-errata/docs
  ```
- You can then view the locally built HTML by pasting the produced link into your
  browser. For me, the built index is stored at `./pedigo-errata/docs/_build/html/index.html`


## Questions about the code or paper 
Please get in touch! You are welcome to [make an issue](https://github.com/neurodata/pedigo-errata/issues/new)
